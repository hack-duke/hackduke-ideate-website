        ...
        <Row>
          <Col md={6}>
            <WorkshopSection title={'Workshop 1'} presenter={'Presenter'}
              text={'Lorem ipsum dolor sit amet, sint delicata electram eos at. Eu mundi legendos eam. Esse ancillae eos ea, nam perfecto comprehensam at, an quo lorem labitur propriae. Decore munere singulis ei usu, eu vel accusam evertitur, ne agam sanctus intellegat mei.'} />
